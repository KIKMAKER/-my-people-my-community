...
ActiveRecord::Schema[7.0].define(version: 2022_11_10_143957) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["invitee_id"], name: "index_conversations_on_invitee_id"
    t.index ["invitor_id"], name: "index_conversations_on_invitor_id"
  end
